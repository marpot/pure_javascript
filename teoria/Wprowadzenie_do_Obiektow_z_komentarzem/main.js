...
// -- Nieuporządkowana lista właściwości złożonych z nazwy (klucza) i wartości 
// (para key - value). Nazwa jest łańcuchem a wartość może być dowolnym typem. Jeśli
//  wartością jest funkcja mówimy wtedy, że dana własciwość jest metodą.
