...
// Zakres zmiennej a jej widoczność. Widoczność moze być przysłaniana
...
let zmienna_zakresu_globalnego = "25";



for (let i = 0; i<10; i++){
    zmienna_zakresu_lokalnego = zmienna_zakresu_globalnego;
    zmienna_zakresu_lokalnego = "30";
    console.log("teraz zmienna jest tylko w zakresie lokalnym w pętli for:", zmienna_zakresu_lokalnego);
}

console.log("A to jest zmienna zakresu globalnego: pętla for się skończyła i bierzemy z zakresu globalnego:",zmienna_zakresu_globalnego);
