...
// METODA SLICE
// zwraca nową tablicę, która składa się z części tablicy na której jest wykonywany. Jeśli damy tylko jeden argument, to będzie zwracała od tego elementu (od tego indexu) do końca
items.slice(3);
...
items.join(); //string oddzielony przecinkiem
items.join(" --- ");
