...
// 2. Klawisz -> (stzałka w prawo) przesuwa w prawo slider (do przod, czyli tak jak przy funkcji changeSlide) 
...
window.addEventListener('keydown', key_ChangeSlide)
